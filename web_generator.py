...
6. DOCS_URL constant added — all paths correctly include /docs/
...
def update_sitemap() -> None:
    ...
    body = "".join(
        f"\n  <url><loc>{u}</loc><lastmod>{lm}</lastmod>"
...
# ═══════════════════════════════════════════════════════════════════════════════
# 7. FORCE-REGENERATE ALL STATIC PAGES
# ═══════════════════════════════════════════════════════════════════════════════
